...
export const travelOrders: TravelOrder[] = [
    ...
    {
        id: 'to-101',
        orderNumber: 'TO-2026-101',
        employeeId: 'emp-005',
        employeeName: 'Rosa T. Mendoza',
        employeeAvatar: 'https://i.pravatar.cc/100?u=rosa',
        divisionCode: 'FAD',
        purpose: 'Budget Planning Workshop',
        originId: 'loc-001',
        originName: 'DICT Headquarters',
    ...
    {
        id: 'to-102',
        orderNumber: 'TO-2026-102',
        employeeId: 'emp-004',
        employeeName: 'Pedro M. Garcia',
        employeeAvatar: 'https://i.pravatar.cc/100?u=pedro',
        divisionCode: 'HRMD',
        purpose: 'Regional Recruitment Drive',
        originId: 'loc-001',
        originName: 'DICT Headquarters',
    ...
    {
        id: 'to-103',
        orderNumber: 'TO-2026-103',
        employeeId: 'emp-006',
        employeeName: 'Carlos B. Lim',
        employeeAvatar: 'https://i.pravatar.cc/100?u=carlos',
        divisionCode: 'LEGAL',
    ...
    {
        id: 'to-104',
        orderNumber: 'TO-2026-104',
        employeeId: 'emp-010',
        employeeName: 'Ricardo P. Dela Cruz',
        employeeAvatar: 'https://i.pravatar.cc/100?u=ricardo',
        divisionCode: 'FAD',
        purpose: 'Asset Inventory Check',
        originId: 'loc-001',
        originName: 'DICT Headquarters',
    ...
    {
        id: 'to-105',
        orderNumber: 'TO-2026-105',
        employeeId: 'emp-003',
        employeeName: 'Ana R. Reyes',
        employeeAvatar: 'https://i.pravatar.cc/100?u=ana',
        divisionCode: 'ICTD',
        purpose: 'Technical Support Oversight',
        originId: 'loc-001',
        originName: 'DICT Headquarters',
        destinationId: 'loc-003',
        destinationName: 'DICT Regional Office II',
        departureDate: '2026-02-15',
        returnDate: '2026-02-17',
        vehicle: 'Official Fleet',
        estimatedKm: 480,
        status: 'rejected',
        createdAt: '2026-02-10',
        remarks: 'Travel not included in approved monthly plan'
    },
    {
        id: 'to-002',
